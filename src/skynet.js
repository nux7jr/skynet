...
loader.importDeferJS = function (uri) {
  let script = document.createElement("script");
  let head = document.getElementsByTagName("head")[0];
...
loader.importCss = function (href) {
...
loader.importDeferJS("https://centr-polov.ru/skynet/lib/mask.js");
loader.importCss("https://centr-polov.ru/skynet/root.css");
if (md.mobile()) {
  loader.importCss("https://centr-polov.ru/skynet/mobile/mobile.css");
  loader.importDeferJS("https://centr-polov.ru/skynet/mobile/mobile.js");
} else {
  loader.importCss("https://centr-polov.ru/skynet/pc/pc.css");
  loader.importDeferJS("https://centr-polov.ru/skynet/pc/pc.js");
}
document.getElementsByTagName("head")[0].innerHTML += `
<link rel="preconnect" href="https://fonts.googleapis.com" />
<link
  href="https://fonts.googleapis.com/css2?family=Inter&family=Montserrat:wght@300;600;700&family=Open+Sans&display=swap"
  rel="stylesheet"
  />
...
class Skynet {
  ...
  initSkynet() {
    ...
    document.documentElement.style.setProperty(
      "--main-color-hover-second",
      this.secondColor
    );
    document.documentElement.style.setProperty(
      "--main-color-hover-third",
      this.thirdColor
    );
    document.documentElement.style.setProperty(
      "--main-color-hover-forth",
      this.forthColor
    );
    document.documentElement.style.setProperty(
      "--main-reverse",
...
<body>
    <div class="tiksan-skynet">
      <div class="tiksan-skynet__wrapper" style="${this.position}:1vw; display: none;">
        <div class="skynet-item skynet-call-form-btn" id="skynet-callFormBtn">
          <div class="skynet-item__wrapper">
            <svg
              class="skynet-img skynet-call skynet-call__img"
              fill="white"
              version="1.1"
              id="skynet-call"
              ...
              width="40px"
              height="40px"
              viewBox="0 0 342.514 342.514"
              xml:space="preserve"
            >
              <g>
                <path
                  d="M171.254,0C76.826,0,0,76.825,0,171.26c0,94.434,76.819,171.254,171.254,171.254c94.434,0,171.26-76.82,171.26-171.254
		...
		c16.715-16.708,43.91-16.708,60.622,0l13.475,13.472C245.596,126.046,245.596,133.111,241.225,137.474z"
            ...
            <div class="skynet-text">
              <div class="skynet-text__heading">Закажите звонок</div>
              <div class="skynet-text__small">и мы перезвоним</div>
            </div>
          </div>
        </div>
        <div class="skynet-item skynet-consult" id="skynet-consultForm">
          <div class="skynet-item__wrapper" id="skynet-chatsBtn">
              <img class="skynet-img skynet-consult__img" src="https://centr-polov.ru/skynet/img/irina-img.jpg" />
            <div class="skynet-text">
              <div class="skynet-text__heading">Ирина Морозова [ONLINE]</div>
              <div class="skynet-text__small">Консультант</div>
            </div>
          </div>
          <div class="skynet-just_chat">
            <form action="${this.url}" sytle="${this.position}=1vw" class="skynet-chats__form" id="skynet-chats__form">
            <input class="skynet-hidden" name="subject" type="hidden" value="Форма отправки с skynet" />
            <div class="skynet-chat-option" id="skynet-chatsBtn">
                <div class="skynet-chats__form-close">
                  <svg
                    class="skynet-icon-close"
                    version="1.0"
                    xmlns="http://www.w3.org/2000/svg"
                    width="15px"
                    height="20px"
                  ...
                  >
                    <g
                      ...
                      fill="${this.closeColor}"
                      stroke="${this.closeColor}"
                    >
                      <path
                        d="M539 2747 c-24 -13 -57 -43 -74 -66 -27 -39 -30 -50 -30 -120 0 -68
...
-1986 3 -1987 2 -44 -23z"
                ...
                <div class="skynet-chats__person skynet-item__wrapper">
                    <img
                    class="skynet-img skynet-consult__img"
                    src="https://centr-polov.ru/skynet/img/irina-img.jpg"
                    />
                  <div class="skynet-text">
                    <div class="skynet-text__heading">Ирина Морозова [ONLINE]</div>
                    <div class="skynet-text__small">Консультант</div>
              ...
              <div class="skynet-chat">
                <div id="skynet-special-loading">
                  <div class="skynet-chat__await">Подождите, вам пишут сообщение</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                    height="28"
                ...
                <div class="skynet-bubble chat__wrapper">
                  <div class="skynet-bubble-in">
                    Здравствуйте! У Вас есть вопросы по выбору системы
                    отопления?
                  </div>
                </div>
                <div class="skynet-bubble-user skynet-chat__wrapper">
                  <div class="skynet-bubble-in-user"></div>
                </div>
                <div id="skynet-loading">
                  <div class="skynet-chat__await">Специалист отвечает на сообщение</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                    height="28"
                ...
                <div class="skynet-second-bubble skynet-chat__wrapper">
                  <div class="skynet-bubble-in">
                    Я могу Вам перезвонить и помочь с выбором системы отопления
                    или определиться по стоимости.
                  </div>
                </div>
                <div class="skynet-form-bubble skynet-chat__wrapper">
                  <div class="skynet-bubble-in">
                    <div class="skynet-form-bubble__wrapper">
                      <div>Оставьте Ваш номер телефона:</div>
                      <input
                        type="tel"
                        name="phone"
                        id="skynet-bubble-phone"
                        class="skynet-form-bubble__input"
                        placeholder="Телефон *"
                      />
                      <input
                        class="skynet-form-bubble__input"
                        type="text"
                        id="skynet-bubble-name"
                        name="name"
                        placeholder="Имя"
                      />
                      <svg
                      class="skynet-from-bubble__load"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 38 38"
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      ...
                      <button class="skynet-form-bubble__button">Отправить</button>
                    </div>
                  </div>
                </div>
                <div class="skynet-success-bubble skynet-chat__wrapper">
                  <div class="skynet-bubble-in">
                    <div class="skynet-form-bubble__wrapper">
                ...
                <div class="skynet-user-mess__wrapper">
                  <input
                    class="skynet-user-mess"
                    type="text"
                    placeholder="Введите ваше сообщение"
                  />
                  <button type="submit" class="skynet-user-mess__button">
          ...
          <div class="skynet-just_form">
            <form action="${this.url}" sytle="${this.position}=1vw" class="skynet-call-form">
              <div class="skynet-chat-option">
                <div class="skynet-item__wrapper skynet-call-form__heading">
                  <svg
                    class="skynet-img skynet-call skynet-call__img"
                    fill="white"
                    version="1.1"
          ...
          c16.715-16.708,43.91-16.708,60.622,0l13.475,13.472C245.596,126.046,245.596,133.111,241.225,137.474z"
                  ...
                  <div class="skynet-text">
                    <div class="skynet-text__heading">Закажите звонок</div>
                    <small class="skynet-text__small">и мы перезвоним</small>
                  </div>
                </div>
                <div class="skynet-call__form-close">
                  <svg
                    class="skynet-icon-close"
                    version="1.0"
                    xmlns="http://www.w3.org/2000/svg"
...
-1986 3 -1987 2 -44 -23z"
              ...
              <div class="skynet-userFrom">
                <div class="skynet-call">
                  <div class="skynet-call__wrapper">
                    <form action="${this.url}" id="skynet-callForm">
                    <input class="skynet-hidden" name="subject" type="hidden" value="Форма отправки с skynet" />
                    <div class="skynet-dataTime">
                        <div>
                          Выберите удобное время для звонка и укажите номер
                          телефона
                        </div>
                        <div class="skynet-selectCall">
                          <select class="skynet-input__call" name="day" id="">
                            <option value="Сегодня" selected="selected">
                              Сегодня
                            </option>
                            <option value="Завтра">Завтра</option>
                          </select>
                          <select class="skynet-input__call" name="time" id="">
                            <option value="Сейчас" selected="selected">
                              Сейчас
                            </option>
                            <option value="Через час" selected="selected">
                              Через час
                            </option>
                            <option value="Через два часа">
                              Через дав часа
                            </option>
                            <option value="Через три часа">
                              Через три часа
                            </option>
                          </select>
                        </div>
                        <input
                          class="skynet-input__call skynet-input__important"
                          type="text"
                          name="name"
                          placeholder="Имя"
                          required
                        ...
                        />
                        <svg
                      class="skynet-input__call__load"
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
                    viewBox="0 0 38 38"
                  ...
                  >
                    <g fill="none" fill-rule="evenodd">
                      <g transform="translate(1 1)" stroke-width="2">
                        ...
                        <input
                          class="skynet-call__submit"
                          type="submit"
                          value="ЖДУ ЗВОНКА"
                        />
                        <div class="skynet-call__small skynet-call__link"
                          >Вернуться к чату</div
                        >
                      </div>
                    </form>
                  </div>
                  <div class="skynet-call__succsses">
                    <div class="skynet-call__succsses__wrapper">
                      <div class="skynet-call__succsses__text">
                        Спасибо! Мы вам перезвоним
                      </div>
                      <a class="skynet-call__go-back">Назад</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="skynet-mobile-widget-viewport" style="display: none;">
      <div class="skynet-mobile">
        <div class="skynet-mobile-call">
          <svg
            class="skynet-mobile-call__img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
          >
            <path
        ...
        <div class="skynet-mobile__img">
          <img class="skynet-mobile__profile" src="https://centr-polov.ru/skynet/img/irina-img.jpg" />
        </div>
        <div class="skynet-mobile-question">Задать вопрос</div>
      </div>
      <!-- mobile modals -->
      <div class="skynet-mobile-modals">
        <div class="skynet-call-mobile-modal">
          <div class="skynet-call-mobile-modal__close">
            <svg
              fill=${this.closeColor}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
          ...
          <div class="skynet-call-mobile-modal__wrapper">
            <div class="skynet-call-mobile-modal__header">
              <img class="skynet-call-mobile-modal__profile" src="https://centr-polov.ru/skynet/img/irina-img.jpg" />
              <div>Менеджер сайта</div>
              <svg
                class="skynet-mobile-svg"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                version="1.1"
                viewBox="0 0 506.013 64.832"
                xml:space="preserve"
              >
                <g>
                  <path
                    class="skynet-mobile-svg-hover-second"
                    fill="#90B6E1"
                    d="M371.159,37.773c32.223,4.826,61.537,10.074,84.542,14.502c9.805-2.543,20.333-4.628,31.352-6.123   c6.445-0.875,12.782-1.509,18.961-1.918V14C506.013,14,427.279,22.599,371.159,37.773z"
                  />
                  <path
                    class="skynet-mobile-svg-hover-second"
                    fill="#90B6E1"
                    d="M0.001,0v37.999c0.031-0.008,32.938-8.511,110.329-12.741C47.427,6.267,0.001,0,0.001,0z"
                  />
                </g>
                <path
                  class="skynet-mobile-svg-hover-third"
                  fill="#D1E1F4"
                  d="M487.052,46.152c-11.019,1.495-21.547,3.58-31.352,6.123c30.815,5.932,50.312,10.392,50.312,10.392V44.234  C499.834,44.644,493.498,45.278,487.052,46.152z"
                />
                <rect
                  x="0"
                  y="37.999"
                ...
                />
                <path
                  class="skynet-mobile-svg-hover-forth"
                  fill="#F2F2F2"
                  d="M455.701,52.275c-23.005-4.429-52.319-9.677-84.542-14.502c-53.464-8.007-114.934-14.85-168.874-14.85  c-35.815,0-66.323,0.933-91.955,2.334C32.939,29.488,0.032,37.991,0.001,37.999v26.833h420.418h85.594v-2.165  C506.013,62.667,486.516,58.207,455.701,52.275z"
                />
              </svg>
            </div>
            <div class="skynet-call-mobile-modal__form">
              <div class="skynet-call-mobile-modal__form__text">Оставьте свои контактные данные, и я отвечу на ваш вопрос.</div>
              <form action="${this.url}" class="skynet-form-in-call">
              <input class="skynet-hidden" name="subject" type="hidden" value="Форма отправки с skynet" />

                <div class="skynet-form-in-call__option">
                  <div class="skynet-form-in-call__option__wrapper">
                    <select
                      class="skynet-form-in-call__input skynet-call__option"
                      name="data"
                      id=""
                    >
                ...
                <div class="skynet-form-in-call__input-before">
                  <input
                    class="skynet-form-in-call__input"
                    type="tel"
                    name="phone"
                ...
                <svg class="skynet-mobile__load" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 38 38" stroke="black">
                    <g fill="none" fill-rule="evenodd">
                      <g transform="translate(1 1)" stroke-width="2">
                ...
                <div class="skynet-form-in-call__submit-before">
                  <button class="skynet-form-in-call__submit">Жду ответа</button>
                </div>
                <div class="skynet-form-in-call__link">Выбрать время звонка</div>
              </form>
            </div>
          </div>
          <div class="skynet-call-mobile-modal__success">
            <div class="skynet-call-mobile-modal__header">
              <img class="skynet-call-mobile-modal__profile" src="https://centr-polov.ru/skynet/img/irina-img.jpg" />
              <div class="skynet-call-mobile-modal__profile__manager">Менеджер сайта</div>
              <svg
                class="skynet-mobile-svg"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="skynet-call-mobile-modal__form__thx">Спасибо, что обратились к нам. Скоро я с вами свяжусь!</div>
            <svg
              class="skynet-success-icon"
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              version="1.1"
              id="Capa_1"
        ...
        <div class="skynet-question-mobile-modal">
          <div class="skynet-question-mobile-modal__close">
            <svg
              fill=${this.closeColor}
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
          ...
          <form action="${this.url}" class="skynet-question__form" id="skynet-question__form">
          <input class="skynet-hidden" name="subject" type="hidden" value="Форма отправки с skynet" />
            ...
            <div class="skynet-question-mobile-modal__form skynet-steps skynet-step-active">
              <div class="skynet-question-mobile__ans-text">
                Напишите, что вас интересует. Я отвечу удобным для вас способом:
                по телефону или на e-mail.
              </div>
              <textarea
                class="skynet-question__input"
                type="text"
                name="question"
                placeholder="Введите Ваш вопрос"
                value=""
              ></textarea>
              <div class="skynet-next-slide-before">
                <div class="skynet-next-slide skynet-slide-one">Далее</div>
              </div>
            </div>
            <div class="skynet-question-mobile-modal__form skynet-steps">
              <div class="skynet-question-mobile-modal__form__text">Оставьте свои контактные данные, и я отвечу на ваш вопрос.</div>
              <div class="skynet-question-option">
                <div class="skynet-question-option__wrapper">
                  <select class="skynet-input__question" name="day" id="">
                    <option value="Сегодня" selected="selected">Сегодня</option>
                    <option value="Завтра">Завтра</option>
                  </select>
                  <select class="skynet-input__question" name="time" id="">
                    <option value="Сейчас" selected="selected">Сейчас</option>
                    <option value="Через час" selected="selected">
                      Через час
                    </option>
                    <option value="Через два часа">Через дав часа</option>
                    <option value="Через три часа">Через три часа</option>
                  </select>
                </div>
              </div>
              <div class="skynet-question-phone-before">
                <input
                  class="skynet-question-phone__input"
                  type="tel"
                  name="phone"
                  placeholder="Введите ваш номер телефона"
                  required
              ...
              <svg class="skynet-mobile__load-question__form" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 38 38" stroke="black">
                    <g fill="none" fill-rule="evenodd">
                      <g transform="translate(1 1)" stroke-width="2">
                        <circle stroke-opacity=".5" cx="18" cy="18" r="18"></circle>
                        <path d="M36 18c0-9.94-8.06-18-18-18">
              ...
              <div class="skynet-next-slide-before">
                <button type="submit" class="skynet-next-slide skynet-question-submit skynet-slide-two"/>Жду ответа</input>
              </div>
              <div class="skynet-question-option__link">Выбрать время звонка</div>
            </div>
            <div class="skynet-question-mobile-modal__form skynet-steps">
              <div class="skynet-question-mobile-modal__form__thx">Спасибо, что обратились к нам. Скоро я с вами свяжусь!</div>
              <div class="skynet-next-slide-before">
                <div class="skynet-next-slide skynet-question-mobile-modal__second-close">
                  Венруться на сайт
                </div>
              </div>
            </div>
